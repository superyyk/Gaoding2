...
export class show_model{
	constructor(option={}) {
		...
		let cancelColor=option.cancelColor||'#019177';
		let confirmColor=option.confirmColor||'#019177';
		let fn = ()=>{}
	...
	creatView(style,opa,clickEvent,modelInfo){
		...
		view.draw([
		    ...
		    {tag:'font',id:'title',text:modelInfo.tit,textStyles:{size:'20px',color:'#019177'},position:{top:'42%',left:'10%',width:'80%',height:'3%'}},
