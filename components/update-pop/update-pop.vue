<template>
  <view class="prompt-box" v-if="visible" @touchmove.stop.prevent="true">
    <view class="prompt">
      <view class="prompt-top">
        <text class="prompt-title" style="font-size: large; font-weight: 700;">{{title}}</text>
   <!--     <input v-if="!isMutipleLine" class="prompt-input" :style="inputStyle" type="number" :placeholder="placeholder" v-model="value">
     ...
     <view class="prompt-buttons" hover-class="hv">
